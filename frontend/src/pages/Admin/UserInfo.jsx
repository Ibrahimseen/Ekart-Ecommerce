...
const UserInfo = () => {
  ...
  const [showImage, setShowImage] = useState(false); // show imgage when user click
        ...
        <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100 ">
          ...
          <div className="w-full flex justify-between items-start px-7 max-w-2xl ">
            ...
            <div className="flex flex-col items-center">
              {/* show image is true then its render in full screen */}
              {showImage && (
                <div
                ...
                >
                  <img
                    src={updateUser?.profilePic || "/user.avif"}
                    alt="Profile"
