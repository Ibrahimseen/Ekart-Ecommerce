...
const AddressForm = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      if (res.data.success) {
        toast.success("order added Successfulyy");
  ...
  const shipping = subtotal > 50 ? 0 : 125;
  const tax = parseFloat((subtotal * 0.05).toFixed(2));
  const total = subtotal + shipping + tax;

  return (
    <div className="max-w-7xl mx-auto grid place-items-center p-10 ">
      <div className="grid grid-cols-1 lg:grid-cols-2 items-start gap-20 mt-10 max-w-7xl mx-auto">
